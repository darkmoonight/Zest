...
class SnackBarOverlay {
  ...
  /// Notifies listeners when toast visibility or content changes.
...
class SnackBarData {
  ...
  /// Whether to style as an error toast.
  final bool isError;

  /// Whether to style as an info toast.
  final bool isInfo;

  /// Optional action invoked from the toast button.
  final VoidCallback? onPressed;

  /// Unique timestamp used as a widget key for re-shows.
...
class _ToastOverlay extends StatefulWidget {
  ...
  /// Toast content and styling to display.
