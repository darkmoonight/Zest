...
class Statistics extends StatelessWidget {
  ...
  Widget _buildTextColumn(BuildContext context) => Flexible(
    child: Column(
  ...
  Widget _buildCompletionText(BuildContext context) => Padding(
  ...
  Widget _buildCircularSlider(BuildContext context) => SleekCircularSlider(
