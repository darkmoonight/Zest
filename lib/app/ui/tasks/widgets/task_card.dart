...
class _TaskCardState extends State<TaskCard> {
  ...
  Widget _buildLeadingWidget(BuildContext context) => SizedBox(
    height: 60,
    width: 60,
    child: SleekCircularSlider(
      appearance: CircularSliderAppearance(
        ...
        infoProperties: InfoProperties(
          modifier: (percentage) =>
              widget.createdTodos != 0 ? '${widget.percent}%' : '0%',
  ...
  Widget? _buildSubtitle() => widget.task.description.isNotEmpty
      ? Text(
