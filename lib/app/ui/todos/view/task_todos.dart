...
class _TodosTaskState extends State<TodosTask> with TickerProviderStateMixin {
  ...
  List<Widget> _buildActions(BuildContext context, ColorScheme colorScheme) {
    return [
      ...
      if (todoController.selectedTodo.isEmpty)
        _buildEditIconButton(context, colorScheme),
      if (todoController.selectedTodo.isNotEmpty)
  ...
  Widget _buildEditIconButton(BuildContext context, ColorScheme colorScheme) {
    return IconButton(
  ...
  Widget _buildDeleteIconButton(BuildContext context, ColorScheme colorScheme) {
    return IconButton(
      icon: Icon(IconsaxPlusLinear.trash_square, size: 22, color: colorScheme.error),
