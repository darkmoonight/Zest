class ZhCN {
  Map<String, String> get messages => {
    ...
    'dataManagement': '数据管理',
    'aboutApp': '关于应用',
    'highPriorityNotif': '高优先级',
    'highPrioritySubtitle': '响铃 + 强振动',
    'mediumPriorityNotif': '中优先级',
    'mediumPrioritySubtitle': '声音 + 适度振动',
    'lowPriorityNotif': '低优先级',
    'lowPrioritySubtitle': '静音 + 轻振动',
    'noPriorityNotif': '无优先级',
    'noPrioritySubtitle': '静音 + 无振动',
    'sound': '声音',
    'vibration': '振动',
