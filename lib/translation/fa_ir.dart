class FaIr {
  Map<String, String> get messages => {
    ...
    'selectNewStatus': 'وضعیت جدیدی برای این وظیفه انتخاب کنید',
    ...
    'highPriorityNotif': 'اولویت بالا',
    'highPrioritySubtitle': 'صدای بلند + لرزش شدید',
    'mediumPriorityNotif': 'اولویت متوسط',
    'mediumPrioritySubtitle': 'صدا + لرزش متوسط',
    'lowPriorityNotif': 'اولویت پایین',
    'lowPrioritySubtitle': 'بی‌صدا + لرزش خفیف',
    'noPriorityNotif': 'بدون اولویت',
    'noPrioritySubtitle': 'بی‌صدا + بدون لرزش',
    'sound': 'صدا',
    'vibration': 'لرزش',
    "editCategoryHint": "ویرایش اطلاعات دسته",
    "createCategoryHint": "ایجاد یک دسته جدید برای کارها",
    "enterCategoryName": "نام دسته را وارد کنید",
    "enterDescription": "افزودن توضیحات",
    "categoryColor": "رنگ دسته",
    "selectedColor": "رنگ انتخاب‌شده",
    "change": "تغییر",
    "selectColor": "انتخاب رنگ",
    "editTodoHint": "ویرایش اطلاعات کار",
    "createTodoHint": "ایجاد یک کار جدید",
    "category": "دسته",
    "details": "جزئیات",
    "enterTodoName": "نام کار را وارد کنید",
    "addTags": "افزودن برچسب‌ها",
    "todoAttributes": "ویژگی‌های کار",
    "transferTodoHint": "مقصد را انتخاب کنید",
    "movingTodos": "کارهای در حال انتقال",
    "transferMode": "حالت انتقال",
    "destination": "مقصد",
    "move": "انتقال",
    "skip": "رد کردن",
    "back": "بازگشت",
    "selectColorHint": "برای دسته رنگ انتخاب کنید",
    "add": "افزودن",
    "addCategoryHint": "یک دسته برای سازماندهی کارها ایجاد کنید",
    "addArchiveCategoryHint": "دسته‌های آرشیو شده این‌جا نمایش داده می‌شوند",
    "remaining": "باقی‌مانده",
    "perfectWork": "عالی!",
    "almostDone": "نزدیک به پایان!",
    "keepGoing": "به راه ادامه دهید!",
    "goodStart": "شروع خوبی بود!",
    "letsStart": "شروع کنیم!",
    "todosProgress": "پیشرفت کارها",
    "completedTodoHint": "کارهای تمام‌شده این‌جا نمایش داده می‌شوند",
    "addTodoHint": "یک کار ایجاد کنید تا شروع کنید",
    "addCalendarTodoHint": "کارها با مهلت این‌جا نمایش داده می‌شوند",
    "item": "آیتم",
    "items": "آیتم‌ها",
    "creatingBackup": "در حال ایجاد نسخه پشتیبان",
    "restoringBackup": "در حال بازیابی نسخه پشتیبان",
    "search": "جستجو...",
    ...
    'save': 'ذخیره',
    'markWithSubtasks': 'علامت‌گذاری با زیرمجموعه‌ها',
