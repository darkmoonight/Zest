class FaIr {
  Map<String, String> get messages => {
    ...
    'categoryOptionalHint': "دسته‌بندی (پیش‌فرض: 'Default')",
    'createCategoryFirstHint': 'ابتداً یک دسته‌بندی بسازید تا تسک ذخیره شود.',
    'setDefaultCategory': 'تنظیم به عنوان دسته‌بندی پیش‌فرض',
    'defaultCategorySet': 'دسته‌بندی پیش‌فرض تنظیم شد',
    'defaultCategoryCleared': 'دسته‌بندی پیش‌فرض پاک شد',
