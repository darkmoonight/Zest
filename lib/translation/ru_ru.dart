class RuRu {
  Map<String, String> get messages => {
    ...
    'selectNewStatus': 'Выберите новый статус для этой задачи',
    ...
    'highPriorityNotif': 'Высокий приоритет',
    'highPrioritySubtitle': 'Громкий звук + сильная вибрация',
    'mediumPriorityNotif': 'Средний приоритет',
    'mediumPrioritySubtitle': 'Звук + умеренная вибрация',
    'lowPriorityNotif': 'Низкий приоритет',
    'lowPrioritySubtitle': 'Без звука + лёгкая вибрация',
    'noPriorityNotif': 'Без приоритета',
    'noPrioritySubtitle': 'Без звука + без вибрации',
    'sound': 'Звук',
    'vibration': 'Вибрация',
    ...
    'creatingAutoBackup': 'Создание автоматической резервной копии.c..',
