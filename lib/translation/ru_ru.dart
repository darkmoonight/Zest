class RuRu {
  Map<String, String> get messages => {
    ...
    'editCategoryHint': 'Изменить информацию о категории',
    'createCategoryHint': 'Создать новую категорию для задач',
    ...
    'editTodoHint': 'Изменить информацию о задаче',
    'createTodoHint': 'Создать новую задачу',
    'category': 'Категория',
    ...
    'movingTodos': 'Перемещаемых задач',
    ...
    'addArchiveCategoryHint': 'Архивированные категории появятся здесь',
    'remaining': 'Осталось',
    'perfectWork': 'Отлично!',
    ...
    'completedTodoHint': 'Завершенные задачи появятся здесь',
    'addTodoHint': 'Создайте задачу для начала работы',
    'addCalendarTodoHint': 'Задачи с дедлайном появятся здесь',
  };
}
