...
<p align='center'>
    Categories, subtasks, calendar, statistics, and smart reminders — with Material You and 16 languages.
</p>
...
APK and other builds: [Releases](https://github.com/darkmoonight/Zest/releases/latest)
...
**Stack:** Flutter, Riverpod, Go Router, Isar, Slang, flutter_local_notifications.

**Tests:** run `flutter test` and `flutter analyze`. Details in [CONTRIBUTING.md](./CONTRIBUTING.md).
